...
export PREFIX_YTDLP=/data/data/com.ytdlp/files/usr
...
function link_one_ffmpeg() {
  ...
  -L$PREFIX_YTDLP/lib -soname libffmpeg.so \
  -shared -Bsymbolic --whole-archive --no-undefined -o $PREFIX_YTDLP/libffmpeg.so \
  $PREFIX_YTDLP/lib/libavcodec.a \
  $PREFIX_YTDLP/lib/libavfilter.a \
  $PREFIX_YTDLP/lib/libswresample.a \
  $PREFIX_YTDLP/lib/libavformat.a \
  $PREFIX_YTDLP/lib/libavutil.a \
  $PREFIX_YTDLP/lib/libswscale.a \
  $PREFIX_YTDLP/lib/libmp3lame.a \
  $PREFIX_YTDLP/lib/libx264.a \
  $PREFIX_YTDLP/lib/libssl.a \
  $PREFIX_YTDLP/lib/libcrypto.a \
